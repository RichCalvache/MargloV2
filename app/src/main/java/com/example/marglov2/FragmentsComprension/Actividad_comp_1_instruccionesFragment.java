 ...
 * Use the {@link Actividad_comp_1_instruccionesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Actividad_comp_1_instruccionesFragment extends Fragment {
    ...
    public Actividad_comp_1_instruccionesFragment() {
     ...
     * @return A new instance of fragment Actividad_comp_1_instruccionesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Actividad_comp_1_instruccionesFragment newInstance(String param1, String param2) {
        Actividad_comp_1_instruccionesFragment fragment = new Actividad_comp_1_instruccionesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_actividad_comp_1_instrucciones, container, false);
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        //Reproducir sonidos
        //sonido_instrucciones = MediaPlayer.create(getActivity(), R.raw.comp_2_instrucciones);
        ...
        instrucciones.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                ...
                sonido_instrucciones = MediaPlayer.create(getActivity(), R.raw.comp_1_instrucciones);
        ...
        ejemplo.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                ...
                sonido_ejemplo = MediaPlayer.create(getActivity(), R.raw.comp_1_ejemplo);
