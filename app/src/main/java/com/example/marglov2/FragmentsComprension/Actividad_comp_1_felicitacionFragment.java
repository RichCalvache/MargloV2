 ...
 * Use the {@link Actividad_comp_1_felicitacionFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Actividad_comp_1_felicitacionFragment extends Fragment {
    ...
    public Actividad_comp_1_felicitacionFragment() {
     ...
     * @return A new instance of fragment Actividad_comp_1_felicitacionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Actividad_comp_1_felicitacionFragment newInstance(String param1, String param2) {
        Actividad_comp_1_felicitacionFragment fragment = new Actividad_comp_1_felicitacionFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_actividad_comp_1_felicitacion, container, false);
    }



    //Se recomienda crear onviewcreated para trabajar cuando la vista esta creada correctamente
    @Override
...
//boton intentar
        ...
        btn_intentar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navControllermio.navigate(R.id. action_actividad_comp_1_felicitacionFragment_to_actividad_comp_1Fragment); //pasar a otro fragment con actions
...
//boton Siguiente
        ...
        btn_siguiente.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navControllermio.navigate(R.id.action_actividad_comp_1_felicitacionFragment_to_actividad_comp_2Fragment);
                //Para actualizar barra de progreso
                guardarPreferenciasTotalPuntaje();
                getActivity().recreate();
            }
