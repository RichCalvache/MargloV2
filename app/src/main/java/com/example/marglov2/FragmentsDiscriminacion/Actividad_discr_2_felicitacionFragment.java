 ...
 * Use the {@link Actividad_discr_2_felicitacionFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Actividad_discr_2_felicitacionFragment extends Fragment {
    ...
    public Actividad_discr_2_felicitacionFragment() {
     ...
     * @return A new instance of fragment Actividad_discr_2_felicitacionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Actividad_discr_2_felicitacionFragment newInstance(String param1, String param2) {
        Actividad_discr_2_felicitacionFragment fragment = new Actividad_discr_2_felicitacionFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_actividad_discr_2_felicitacion, container, false);
    }
...
//boton intentar
        ...
        btn_intentar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navControllermio.navigate(R.id. action_actividad_discr_2_felicitacionFragment_to_actividad_discr_2Fragment); //pasar a otro fragment con actions
...
//boton Siguiente
        ...
        btn_siguiente.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navControllermio.navigate(R.id.action_actividad_discr_2_felicitacionFragment_to_actividad_discr_3Fragment); //pasar a otro fragment con actions
                //Para actualizar barra de progreso
                guardarPreferenciasTotalPuntaje();
                getActivity().recreate();
            }
