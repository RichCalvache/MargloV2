 ...
 * Use the {@link Actividad_conc_1_erradoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Actividad_conc_1_erradoFragment extends Fragment {
    ...
    public Actividad_conc_1_erradoFragment() {
     ...
     * @return A new instance of fragment Actividad_conc_1_erradoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Actividad_conc_1_erradoFragment newInstance(String param1, String param2) {
        Actividad_conc_1_erradoFragment fragment = new Actividad_conc_1_erradoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_actividad_conc_1_errado, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        btn_reintentar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navControllermio.navigate(R.id. action_actividad_conc_1_erradoFragment_to_actividad_conc_1Fragment); //pasar a otro fragment con actions

                //Shared PReferences para agregar ayudas
                SharedPreferences preferencesayudas = getActivity().getSharedPreferences("PreferenciasAyudas", Context.MODE_PRIVATE);
                boolean visuales = true;
                boolean tactiles = true;
