...
import com.example.marglov2.FragmentsIdentificación.juego_presentarFragment;
...
public class AdaptadorCartas2 extends RecyclerView.Adapter<AdaptadorCartas2.ViewHolderCartas> {

    //MediaPlayer sonido;

    private RecyclerClickJuegoInterface recyclerClickJuegoInterface;

    ArrayList<CartasVo2> listaCartas, listaSeleccion;
    ...
    private CartasVo2 cartaSeleccionada1,cartaSeleccionada2;
    ...
    public AdaptadorCartas2(ArrayList<CartasVo2> listaCartas, juego_presentarFragment recyclerClickJuegoInterface) {
...
*/
                ...
                if(cartaSeleccionada1.getImagenId() == listaCartas.get(position).getImagenId()){//si el 1ero tiene el mismo imagenId del segundo seleccionado entonces suma punto o hace match
                    ...
                    if(cartaSeleccionada1.getId() == listaCartas.get(position).getId()){//revisa si selecciona el mismo dos veces
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //holder.cardviewCarta.setClickable(false);
                                //holder.itemView.setClickable(false);


                                //CardView cardviewCartaSeleccionada = rv_view.itemView.findViewById(R.id.cardCarta);

                                //View viewItem = recyclerViewJuego.getLayoutManager().findViewByPosition(posicion_anterior);
                                //CardView cardviewCartaSeleccionada = viewItem.findViewById(R.id.cardCarta);

                                //holder.cardviewCartaSeleccionada.setVisibility(View.INVISIBLE);
                                //cardviewCartaSeleccionada.setClickable(false);

                                //myViewHolders.get(posicion_anterior).cardviewCarta.setVisibility(View.INVISIBLE);
                                //myViewHolders.get(posicion_anterior).itemView.setVisibility(View.INVISIBLE);
                                ...
                                //dejar las cartas volteadas, sin click, y cambiar carta
                                ...
                                if(puntos>=4){
                                    ...
                                    navControllermio.navigate(R.id.actividad_ident_1_felicitacionFragment);
